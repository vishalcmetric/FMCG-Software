...
from orm_models import (
    Base, Project, Task, AuditLog, User, MasterConfig,
...
# ─────────────────────────────────────────────────────────────
PROJECTS = [
    dict(project_id="NP-2026-001", name="Complan Pro Chocolate Boost",     brand="Complan",    type="New Product",         status="PPD Review",        progress=25,  priority="High",     owner="Rahul Mehta",    owner_email="source@fmcgsoftware.com",     teams_involved=ALL, objective="Premium chocolate nutrition powder with 34 nutrients targeting kids 5-15 yrs.",  created_at=NOW-timedelta(days=10), updated_at=NOW-timedelta(hours=2)),
    dict(project_id="NP-2026-002", name="Sugar Free Green Stevia+",         brand="Sugar Free", type="Product Improvement", status="Formulation",       progress=55,  priority="Medium",   owner="Priya Sharma",   owner_email="fd@fmcgsoftware.com",         teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=8),  updated_at=NOW-timedelta(hours=5)),
    dict(project_id="NP-2026-003", name="Nycil Cool Menthol XT",            brand="Nycil",      type="Innovation",          status="Plant Trial",       progress=78,  priority="High",     owner="Anil Kumar",     owner_email="production@fmcgsoftware.com", teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=15), updated_at=NOW-timedelta(hours=1)),
    dict(project_id="NP-2026-004", name="Glucon-D Immunity+ Orange",        brand="Glucon-D",   type="AVD",                 status="Regulatory Review", progress=62,  priority="Medium",   owner="Sneha Patel",    owner_email="regulatory@fmcgsoftware.com", teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=7),  updated_at=NOW-timedelta(hours=3)),
    dict(project_id="NP-2026-005", name="Everyuth Naturals Aloe Face Wash", brand="Everyuth",   type="Cost Reduction",      status="CEO Approval",      progress=92,  priority="Critical", owner="Vikram Singh",   owner_email="source@fmcgsoftware.com",     teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=20), updated_at=NOW-timedelta(minutes=30)),
    dict(project_id="NP-2026-006", name="Complan NutriGro Strawberry",      brand="Complan",    type="New Product",         status="Draft",             progress=10,  priority="Low",      owner="Rahul Mehta",    owner_email="source@fmcgsoftware.com",     teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=2),  updated_at=NOW-timedelta(hours=6)),
    dict(project_id="NP-2025-098", name="Nutralite Choco Spread Lite",      brand="Nutralite",  type="Sustainability",      status="Completed",         progress=100, priority="Medium",   owner="Meera Iyer",     owner_email="rd_head@fmcgsoftware.com",    teams_involved=ALL,                                                                             created_at=NOW-timedelta(days=60), updated_at=NOW-timedelta(days=5)),
]
...
# ─────────────────────────────────────────────────────────────
TASKS = [
    dict(title="Review & approve PPD v2.1",          project_name="Complan Pro Chocolate Boost",    project_id="NP-2026-001", assigned_role="source",     type="approval",    status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Approve Formulation F-04",            project_name="Sugar Free Green Stevia+",       project_id="NP-2026-002", assigned_role="rd_head",    type="approval",    status="pending", priority="Medium",   due_date=NOW+timedelta(days=1),  due_label="Tomorrow"),
    dict(title="Submit Sensory Evaluation Report",    project_name="Everyuth Naturals Aloe Face Wash",project_id="NP-2026-005",assigned_role="pmsa",       type="sensory",     status="pending", priority="Critical", due_date=NOW,                    due_label="Today"),
    dict(title="Complete Regulatory Assessment",      project_name="Glucon-D Immunity+ Orange",      project_id="NP-2026-004", assigned_role="regulatory", type="regulatory",  status="pending", priority="Medium",   due_date=NOW+timedelta(days=2),  due_label="2 days"),
    dict(title="Update formula F-04 protein %",       project_name="Complan Pro Chocolate Boost",    project_id="NP-2026-001", assigned_role="fd",         type="formulation", status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Lab trial report for F-02",           project_name="Sugar Free Green Stevia+",       project_id="NP-2026-002", assigned_role="fd",         type="labbook",     status="pending", priority="Medium",   due_date=NOW+timedelta(days=1),  due_label="Tomorrow"),
    dict(title="Ingredient compliance check",         project_name="Complan NutriGro Strawberry",    project_id="NP-2026-006", assigned_role="regulatory", type="regulatory",  status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Upload pilot batch report",           project_name="Nycil Cool Menthol XT",          project_id="NP-2026-003", assigned_role="production", type="plant",       status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="ADL protein & fat analysis F-04",     project_name="Complan Pro Chocolate Boost",    project_id="NP-2026-001", assigned_role="adl",        type="labbook",     status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Sensory panel — Sugar Free batch 3",  project_name="Sugar Free Green Stevia+",       project_id="NP-2026-002", assigned_role="pmsa",       type="sensory",     status="pending", priority="Medium",   due_date=NOW+timedelta(days=1),  due_label="Tomorrow"),
    dict(title="Claim substantiation — 34 nutrients", project_name="Complan Pro Chocolate Boost",    project_id="NP-2026-001", assigned_role="sa",         type="claim",       status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Create artwork brief for label",      project_name="Everyuth Naturals Aloe Face Wash",project_id="NP-2026-005",assigned_role="packaging",  type="artwork",     status="pending", priority="High",     due_date=NOW,                    due_label="Today"),
    dict(title="Packaging feasibility — Nycil XT",    project_name="Nycil Cool Menthol XT",          project_id="NP-2026-003", assigned_role="packaging",  type="costing",     status="pending", priority="Medium",   due_date=NOW+timedelta(days=2),  due_label="2 days"),
    dict(title="Review artwork brief v2 (SF Stevia)", project_name="Sugar Free Green Stevia+",       project_id="NP-2026-002", assigned_role="marketing",  type="artwork",     status="pending", priority="Medium",   due_date=NOW+timedelta(days=1),  due_label="Tomorrow"),
    dict(title="Submit PPD brief for NutriGro",       project_name="Complan NutriGro Strawberry",    project_id="NP-2026-006", assigned_role="marketing",  type="approval",    status="pending", priority="Low",      due_date=NOW+timedelta(days=3),  due_label="3 days"),
    dict(title="Assign PM codes for NutriGro",        project_name="Complan NutriGro Strawberry",    project_id="NP-2026-006", assigned_role="pm",         type="master",      status="pending", priority="Medium",   due_date=NOW+timedelta(days=2),  due_label="2 days"),
    dict(title="Schedule scale-up trial (GluconD)",   project_name="Glucon-D Immunity+ Orange",      project_id="NP-2026-004", assigned_role="production", type="plant",       status="pending", priority="Medium",   due_date=NOW+timedelta(days=3),  due_label="3 days"),
    dict(title="CEO final approval — Everyuth Aloe",  project_name="Everyuth Naturals Aloe Face Wash",project_id="NP-2026-005",assigned_role="ceo",        type="approval",    status="pending", priority="Critical", due_date=NOW,                    due_label="Today"),
    dict(title="Management committee Q2 pipeline review",project_name="Complan Pro Chocolate Boost", project_id="NP-2026-001", assigned_role="mgmt",       type="approval",    status="pending", priority="High",     due_date=NOW+timedelta(days=1),  due_label="Tomorrow"),
]
...
PPD_DATA = [
    dict(ppd_id="PPD-NP-2026-001", project_id="NP-2026-001", project_name="Complan Pro Chocolate Boost",     brand="Complan",    product_category="Nutrition Powder",    target_consumer="Kids 5–15 yrs",     market_segment="Premium Health",  expected_launch="Q3 2026", objective="Create a premium chocolate-flavored nutrition powder with 34 essential nutrients to boost immunity and cognitive development.", key_benefits="• 34 essential nutrients\n• Clinically proven immune support\n• Whey protein + DHA",       status="Under Review",  ppd_version="v2.1", teams_involved=ALL, created_by="Rahul Mehta",  created_by_email="source@fmcgsoftware.com",  created_by_role="source",    reviewers=REVIEWERS_PARTIAL, created_at=NOW-timedelta(days=8),  updated_at=NOW-timedelta(hours=2)),
    dict(ppd_id="PPD-NP-2026-002", project_id="NP-2026-002", project_name="Sugar Free Green Stevia+",         brand="Sugar Free", product_category="Sugar Substitute",    target_consumer="Diabetics 30+ yrs", market_segment="Health Conscious", expected_launch="Q2 2026", objective="Develop a premium stevia-based sugar substitute with zero glycemic index and natural green tea extract for antioxidant benefits.",  key_benefits="• Zero glycemic index\n• Natural stevia leaf\n• Green tea antioxidants",                  status="Approved",      ppd_version="v1.2", teams_involved=ALL, created_by="Priya Sharma", created_by_email="fd@fmcgsoftware.com",      created_by_role="fd",        reviewers=REVIEWERS_APPROVED, created_at=NOW-timedelta(days=15), updated_at=NOW-timedelta(days=2)),
    dict(ppd_id="PPD-NP-2026-004", project_id="NP-2026-004", project_name="Glucon-D Immunity+ Orange",        brand="Glucon-D",   product_category="Energy Drink Powder", target_consumer="Adults 25–50 yrs", market_segment="Mass Market",      expected_launch="Q4 2026", objective="AVD of existing Glucon-D with added Vitamin C, Zinc, and Elderberry extract to enhance immune support claims.",                    key_benefits="• Vitamin C 500mg\n• Zinc 10mg\n• Elderberry extract\n• Instant energy",                  status="Rework",        ppd_version="v1.0", teams_involved=ALL, created_by="Sneha Patel",  created_by_email="regulatory@fmcgsoftware.com",created_by_role="regulatory",reviewers=REVIEWERS_PARTIAL, created_at=NOW-timedelta(days=5),  updated_at=NOW-timedelta(hours=6)),
]

PPD_COMMENTS = [
    dict(ppd_id="PPD-NP-2026-001", user_name="Neeraj Kapoor", user_role="marketing", comment="Strong positioning. Need to confirm the '34 nutrients' claim is supported by ADL data before proceeding.", action_tag="comment",   created_at=NOW-timedelta(hours=5)),
    dict(ppd_id="PPD-NP-2026-001", user_name="Admin User",    user_role="admin",     comment="PPD moved to Under Review. All departments please complete your review within 3 working days.",           action_tag="comment",   created_at=NOW-timedelta(hours=4)),
    dict(ppd_id="PPD-NP-2026-001", user_name="Priya Sharma",  user_role="fd",        comment="F&D review in progress. Whey protein sourcing confirmed with Glanbia. Cocoa % being finalized.",         action_tag="comment",   created_at=NOW-timedelta(hours=2)),
    dict(ppd_id="PPD-NP-2026-002", user_name="Amit Verma",    user_role="regulatory",comment="All ingredients are FSSAI Schedule-1 compliant. Stevia extract dose within permitted limits.",           action_tag="approve",   created_at=NOW-timedelta(days=2)),
    dict(ppd_id="PPD-NP-2026-002", user_name="Admin User",    user_role="admin",     comment="PPD approved! Moving to Formulation stage.",                                                              action_tag="approve",   created_at=NOW-timedelta(days=1)),
    dict(ppd_id="PPD-NP-2026-004", user_name="Amit Verma",    user_role="regulatory",comment="Elderberry extract import license pending. PPD needs to be revised with alternate extract or pending license details attached.", action_tag="rework", created_at=NOW-timedelta(hours=6)),
]
...
# ─────────────────────────────────────────────────────────────
COSTING = [
    dict(cost_id="CST-NP-2026-001-01", project_id="NP-2026-001", project_name="Complan Pro Chocolate Boost",
         formula_id="F-NP-2026-001-02",
    ...
    dict(cost_id="CST-NP-2026-002-01", project_id="NP-2026-002", project_name="Sugar Free Green Stevia+",
         formula_id="F-NP-2026-002-01",
    ...
    dict(cost_id="CST-NP-2026-003-01", project_id="NP-2026-003", project_name="Nycil Cool Menthol XT",
         formula_id="F-NP-2026-003-01",
    ...
    dict(cost_id="CST-NP-2026-004-01", project_id="NP-2026-004", project_name="Glucon-D Immunity+ Orange",
         formula_id="F-NP-2026-004-01",
    ...
    dict(cost_id="CST-NP-2026-005-01", project_id="NP-2026-005", project_name="Everyuth Naturals Aloe Face Wash",
         formula_id="F-NP-2026-005-01",
