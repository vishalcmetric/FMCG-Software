...
class Formula(Base):
    ...
    id                    = Column(Integer, primary_key=True, autoincrement=True)
    formula_id            = Column(String(30), unique=True, nullable=False, index=True)
    ...
    protein_source        = Column(String(255), nullable=True)
    sweetener             = Column(String(255), nullable=True)
    cocoa_pct             = Column(String(20), nullable=True)
    protein_pct           = Column(String(20), nullable=True)
    sugar_per_100g        = Column(String(20), nullable=True)
    cost_per_kg           = Column(String(20), nullable=True)
    stability_40c         = Column(String(50), nullable=True)
    sensory_score         = Column(String(20), nullable=True)
    notes                 = Column(Text, nullable=True)
    # New columns (added via migration on existing deployments)
    trial_no              = Column(String(50), nullable=True)
    batch_no              = Column(String(50), nullable=True)
    batch_size            = Column(String(50), nullable=True)
    unit_qty              = Column(String(50), nullable=True)
    mfg_date              = Column(String(30), nullable=True)
    trial_taken_by        = Column(String(255), nullable=True)
    ...
    approved_by           = Column(String(150), nullable=True)  # rd_head name
